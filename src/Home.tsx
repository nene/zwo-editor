  ...
  return (
    <div className="home">
      <Helmet>
        <meta
          name="description"
          content="Edit and share your Zwift workouts directly from your browser"
        />
      ...
      <div className="features">
        ...
        <div className="perks">
          ...
          <div>
            ...
            <p>
              Edit your workout files outside Zwift - don't overload you
              computer
            </p>
          </div>
          <div>
      ...
      <div className="black">
        <div className="about">
          ...
          <div className="bio">
            <h3>Bio</h3>
            <p>
              I'm a full stack developer and I love cycling. I joined Zwift
              during the 2020 lockdown and I loved it.
            </p>
            <p>
